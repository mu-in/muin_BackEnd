package dev.muin.backend.config.otp;
...
public class TOTP {
    ...
    private static byte[] hexStrToBytes(String hex) {
        // BigInteger(value, radix) -> radix-encoded된 String을 radix로 decode해서 십진수로 만듦
    ...
    public static String generateTOTP(String key, String time, String returnDigits, CryptoType type) {
        ...
        int otp = binary % DIGITS_POWER[codeDigits]; //ㅇㅋ 8자리만 남기게 큰 자리 숫자는 제거함
