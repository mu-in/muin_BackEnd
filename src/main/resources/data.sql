...
insert into stock(quantity, store_id, product_id) value (100, 1, 22);
insert into stock(quantity, store_id, product_id) value (100, 1, 44);
insert into stock(quantity, store_id, product_id) value (100, 1, 88);
insert into stock(quantity, store_id, product_id) value (100, 1, 122);
insert into stock(quantity, store_id, product_id) value (100, 2, 144);
insert into stock(quantity, store_id, product_id) value (100, 2, 166);
insert into stock(quantity, store_id, product_id) value (100, 2, 177);
insert into stock(quantity, store_id, product_id) value (100, 3, 1);
insert into stock(quantity, store_id, product_id) value (100, 4, 2);
insert into stock(quantity, store_id, product_id) value (100, 5, 3);
insert into stock(quantity, store_id, product_id) value (100, 6, 4);
insert into stock(quantity, store_id, product_id) value (100, 7, 5);
insert into stock(quantity, store_id, product_id) value (100, 8, 6);
insert into stock(quantity, store_id, product_id) value (100, 9, 7);
